  ...
  <main id="main" class="main">
    ...
    <section class="section">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('testimonials.update') }}" enctype="multipart/form-data" method="post">
                @csrf
                <input type="hidden" name="testimonialId" value="{{ $testimonial->id }}">
            <div class="row mb-3">
                <label for="client_name" class="col-form-label">Client name</label>
                <div class="col-sm-12">
                <input id="client_name" value="{{ $testimonial->client_name }}" name="client_name" type="text" class="form-control">
                </div>
            </div>
            <div class="row mb-3">
                <label for="client_position" class="col-form-label">Client position</label>
                <div class="col-sm-12">
                <input id="client_position" value="{{ $testimonial->client_position }}" name="client_position" type="text" class="form-control">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-12">
                <textarea id="client_review" name="client_review" class="form-control" style="height: 100px">{{ $testimonial->client_review }}</textarea>
                </div>
            </div>

            <div class="row mb-3 mt-3">
                <div class="col-sm-12">
                <button type="submit" id="updateTestimonial" class="btn btn-primary">Update Testimonial</button>
                </div>
            </div>
